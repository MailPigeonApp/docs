...
Your submissions are displayed as a list on the dashboard. You can also view them in a table format.
You can also [download your submissions as a CSV file](/knowledge-base/exporting-csv).
